...
const vs = require('element-ui/package.json').version; // element-ui version from node_modules
  ...
  return {
    ...
    methods: {
      updateTheme(val, oldVal) {
        ...
        let cluster = this.getThemeCluster(oldVal.replace('#', ''));
        const getHandler = (variable, id) => {
          return () => {
            cluster = this.getThemeCluster(
        ...
        if (!this.chalk) {
          const url = `/cdn/element-ui/${vs}/theme-chalk/index.css`;
