...
export default {
  ...
  methods: {
    ...
    handleContextmenu(event) {
      ...
      let flag = false;
      if (targets.className.indexOf('el-tabs__item') > -1) flag = true;
      else if (targets.parentNode.className.indexOf('el-tabs__item') > -1) {
      ...
      if (flag) {
        ...
        this.tagName = targets.getAttribute('aria-controls').slice(5);
